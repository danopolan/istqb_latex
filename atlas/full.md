...
### Connection to Other Certifications in the ISTQB® Scheme
...
## The Advanced Level Agile Test Leadership at Scale Certification Exam
...
1. Optimizes for flow and value delivery
1. Focuses on prevention, automation, and observability
1. Encourages built-in quality practices continuously
1. Supports self-empowered teams by enabling others to take responsibility for quality- and testing-related activities
1. Embeds testing throughout the organization instead of sustaining testing silos
1. Requires agile test leaders and agile test team leaders that serve, rather than test managers that control
1. Has agile test leaders and agile test team leaders helping everyone in the organization collaborate through community of practice events
...
1. Lead time (LT)
1. Wait time (sometimes called delay time)
1. Processing time (PT)
1. Flow efficiency (sometimes called process cycle efficiency or activity ratio)
1. Percent complete and accurate (%C&A)
1. Phase Containment Efficiency (PCE)
...
Structured Problem-Solving Approach for Testing and Quality Activities

ATLaS-3.1.1	(K3) Apply a Plan-Do-Check-Act cycle to address a quality problem ATLaS-3.1.2	(K2) Understand how to embed Plan-Do-Check-Act in the organization

# Systems Thinking and Analysis of Root Causes
...
## Structured Problem-Solving Approach for Testing and Quality Activi- ties
...
1. Define variables.
1. Define causal relationships between variables.
1. Describe what effect one variable has on another.
1. Add other factors that affect the system (e.g., delays and goals).
1. Identify and describe reinforcing and balancing causal loops.
1. Identify possible interventions to resolve the problem.
...
1. Fit Agile Test Leadership in a Value-Driven Organization
...
1. Use of feature toggles
1. Automated control and management of test and production environments used during release stage  
...
1. Blue/green deployment strategy and chaos engineering
...
1. be a practice leader within the testing community of practice (CoP)
1. help teams to identify waste using value stream mapping (VSM)
1. guide teams to capture product quality in their definitions of “ready” and “done”
1. teach teams systems thinking to reduce the risk of local optimization
1. facilitate multi-team retrospectives and process improvement
1. help teams with continuous improvement of their quality capabilities
1. provide System QA and testing expertise to agile teams by leading a specialized service group
1. help to find a good balance between decentralized and centralized testing
...
#	Appendix A – Cognitive Levels of Knowledge
